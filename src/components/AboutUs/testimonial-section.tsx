    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-blue-100">Hear from event organizers and attendees who use our platform</p>
        </motion.div>
            ...
            <CarouselContent>
                ...
                <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl h-full">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200 text-sm">Conference Organizer</p>
                    </div>
                  </div>
                  ...
                  <p className="italic">
                    "EventHub transformed how we manage our annual tech conference. The payment integration and approval
                    workflows save us countless hours of manual work. I can't imagine organizing events without it now!"
                  </p>
                </div>
              </CarouselItem>
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3 p-2">
                <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl h-full">
                  ...
                  <p className="italic">
                    "As someone who runs both free and paid workshops, I love how flexible the platform is. The private
                    event option lets me create exclusive experiences for my community while keeping everything
                    organized."
                  </p>
                </div>
              </CarouselItem>
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3 p-2">
                <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl h-full">
                  ...
                  <p className="italic">
                    "I've discovered so many amazing events through EventHub. The payment process is seamless, and I
                    appreciate knowing that private events are properly vetted. It's become my go-to platform."
                  </p>
                </div>
              </CarouselItem>
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3 p-2">
                <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl h-full">
                  ...
                  <p className="italic">
                    "The analytics and reporting features have completely changed how I approach event planning. Being
                    able to see real-time data on registrations and engagement helps me make better decisions for future
                    events."
                  </p>
                </div>
              </CarouselItem>
