        ...
        >
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-white text-blue-700 hover:bg-blue-50 h-14 px-8 text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <Link href="/events">
                Explore Events
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="text-white border-white hover:bg-white/20 h-14 px-8 text-lg rounded-full backdrop-blur-sm"
            >
