                            ...
                            <Card className="bg-white shadow-md rounded-2xl">
                                ...
                                <CardContent className="space-y-4 text-xl text-[#424242]">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <UserIcon className="w-5 h-5 text-[#FF7043]" />
                                        <span>
                                            <strong>Available Seats :</strong> {Number(event.availableSit) - Number(event.reseveredSit) } 
                                        </span>
                                    </div>
                                </CardContent>
                                <CardFooter className="flex items-center justify-between ">
                                   ...
                                   <div>
                                    ...
                                    <div>
{Number(event.availableSit) - Number(event.reseveredSit) > 0 ?<NextButton name="Register"  /> : <Badge className="bg-[#F8BBD0] text-[#F4511E] border border-[#F8BBD0] text-xl font-semibold">Full</Badge>}
                        ...
                        <div className="space-y-6">
                            <Card className="rounded-2xl shadow-md border border-[#E0E0E0] bg-white">
                                ...
                                <CardContent className="flex items-center gap-4">
                                    <Image
                                        src={organizer?.profileImage || "https://res.cloudinary.com/dp8c6enec/image/upload/v1746463121/s1or7qauhmvo83ltfuwb.jpg"}
                                        alt={organizer?.name}
                                        width={6000}
                                        height={6000}
                            ...
                            <Card className="rounded-2xl shadow-md border border-[#E0E0E0] bg-white">
                                ...
                                <CardContent className="space-y-2 text-xl text-[#424242]">
                                    ...
                                    {organizer?.address && <p><strong>Address:</strong> {organizer?.address}</p>}
